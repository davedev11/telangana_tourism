            ...
            <div class = "container">
                ...
                <div class="container" >
					<div class = "dashboard-box">
						...
						<div class = "gridbox">
						<div class="grid"> Visits for Package-1 : </div>
						<div class="grid">Visits for Package-2 : </div>
						<div class="grid">Visits for Package-3 : </div>
						<div class="grid">Visits for Package-4 : </div>
