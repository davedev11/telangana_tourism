    ...
    <%
    	...
    	if(request.getParameter("proceed")!=null){
    		if(request.getMethod().equalsIgnoreCase("POST")){
	    		...
	    		String insert_sql = "INSERT INTO travthree(package,trav,date,name,mail,mob) values('pack3' , '"+trav+"','"+date+"','"+name+"','"+mail+"', '"+mob+"')";
...
<html>
        ...
        <header class = "flex header-sm">
            <div class = "container">
                <div class = "header-title">
                    <h1>Package3</h1>
                    <p> Round trip to Nagarjuna sagar-Hyderabad</p>
                </div>
            </div>
        </header>
        <!-- header -->
 ...
 <br>NOTE: The above time is estimated only, Actual Schedule of Departure / Arrival may vary due to traffic and other conditions
                        ...
                        <br><br>
                        <img src="../images/nagarjunasagar1.jpg" class="iiimaaageee">
                        <br>
                    ...
                    <div class="box2">
                        ...
                        <section id="form-section"  >
                            <div>
                               <form method="post" class = "contact-form" id = "travForm3" >
                                    <div>
