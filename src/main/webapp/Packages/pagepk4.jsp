   ...
   <%@ page import="tel_tour.DB_conn_manager" %> 
    ...
    if(request.getParameter("proceed")!=null){
		if(request.getMethod().equalsIgnoreCase("POST")){
    		...
    		String insert_sql = "INSERT INTO travfour(package,trav,date,name,mail,mob) values('pack4' , '"+trav+"','"+date+"','"+name+"','"+mail+"', '"+mob+"')";
...
<html>
 ...
 <br>NOTE: The above time is estimated only, Actual Schedule of Departure / Arrival may vary due to traffic and other conditions
                        ...
                        <br><br>
                        <img src="../images/charminar_day.jpg" class="iiimaaageee">
                        <br>
                    ...
                    <div class="box2">
                        ...
                        <div>
                          <form method="post" class = "contact-form" id = "travForm4" >
                                    <div>
